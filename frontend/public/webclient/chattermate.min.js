(()=>{var w=(h,b,t)=>new Promise((m,p)=>{var g=a=>{try{s(t.next(a))}catch(e){p(e)}},f=a=>{try{s(t.throw(a))}catch(e){p(e)}},s=a=>a.done?m(a.value):Promise.resolve(a.value).then(g,f);s((t=t.apply(h,b)).next())});window.chattermateId;window.ChatterMate;(function(){function h(e){return/^#[0-9A-F]{6}$/i.test(e)}function b(){return"http://localhost:8000/api/v1"}let t={baseUrl:b(),containerId:"chattermate-container",buttonId:"chattermate-button",chatBubbleColor:"#f34611",loadingContainerId:"chattermate-loading",tokenKey:"ctid",containerBottom:100,containerRight:20,containerWidth:400};function m(){let e=document.createElement("style");e.id="chattermate-styles",e.textContent=`
      #${t.buttonId} {
        position: fixed;
        bottom: 20px;
        right: 20px;
