...
export function getApiUrl(): string {
  return window.APP_CONFIG?.API_URL || import.meta.env.VITE_API_URL || 'http://localhost:8000/api/v1';
}
...
export function getFirebaseMessagingSenderId(): string {
  return window.APP_CONFIG?.FIREBASE_MESSAGING_SENDER_ID || import.meta.env.VITE_FIREBASE_MESSAGING_SENDER_ID || '';
}
...
export function getFirebaseStorageBucket(): string {
  return window.APP_CONFIG?.FIREBASE_STORAGE_BUCKET || import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || '';
}

export function getFirebaseMeasurementId(): string {
  return window.APP_CONFIG?.FIREBASE_MEASUREMENT_ID || import.meta.env.VITE_FIREBASE_MEASUREMENT_ID || '';
}
